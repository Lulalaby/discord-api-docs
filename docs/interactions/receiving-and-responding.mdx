...
| [Text Input](/docs/components/reference#text-input-text-input-modal-interaction-response-structure)                   |
...
| [Text Display](/docs/components/reference#text-display-text-display-modal-interaction-response-structure)             |
| [Label](/docs/components/reference#label-label-modal-interaction-response-structure)                                  |
