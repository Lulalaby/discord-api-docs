...
File Uploads can be configured for both single-file and multi-file uploads.
...
| min_values?     | integer                                                                                                 | Minimum number of items that must be uploaded (defaults to 1); min 0, max ??                                                                             |
| max_values?     | integer                                                                                                 | Maximum number of items that can be uploaded (defaults to 1); max ??                                                                                     |
| required?       | boolean                                                                                                 | Whether the file upload is required to be used in a modal (defaults to `true`)                                                                           |
...
<Collapsible title="Modal Example" description="Modal create payload with a File Upload component" icon="code">
  ...
  <Collapsible title="Rendered Example" description="Visualization of the message created by the payload below" icon="image" nested={true}>
    ![Example of a modal with a File Upload](images/components/modal-file-upload.webp)
  </Collapsible>
  ...
  ```json
  {
    "type": 9,
    "data": {
      "custom_id": "pet_pictures_modal",
      "title": "Pet Pictures",
      "components": [
        {
          "type": 18, // ComponentType.LABEL
          "label": "Send me some pictures of your pet!",
          "component": {
      ...
      "resolved": {
        "attachments": {
          "11111111111111111": {
            ...
            "size": 12345,
            "url": "https://cdn.discordapp.com/attachments/11111111111111111/22222222222222222/image.png",
            "proxy_url": "https://media.discordapp.net/attachments/11111111111111111/22222222222222222/image.png",
            "height": 512,
            "width": 512,
            "ephemeral": false,
            "flags": 0
