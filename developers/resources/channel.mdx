...
<ManualAnchor id="channel-object-channel-structure" />
###### Channel Structure
...
| permission_overwrites?              | array of [overwrite](/developers/resources/channel#overwrite-object) objects      | explicit permission overwrites for members and roles                                                                                                                                                                                                                                                   |
...
| rtc_region?                         | ?string                                                                           | [voice region](/developers/resources/voice#voice-region-object) id for the voice channel, automatic when set to null                                                                                                                                                                                   |
| video_quality_mode?                 | integer                                                                           | the camera [video quality mode](/developers/resources/channel#channel-object-video-quality-modes) of the voice channel, 1 when not present                                                                                                                                                             |
...
| thread_metadata?                    | a [thread metadata](/developers/resources/channel#thread-metadata-object) object  | thread-specific fields not needed by other channels                                                                                                                                                                                                                                                    |
...
| app_permissions?                    | string                                                                            | computed permissions for the bot user in the channel, including overwrites, only included when part of the `resolved` data received on an interaction. This does not include [implicit permissions](/developers/topics/permissions#implicit-permissions), which may need to be checked separately      |
...
| available_tags?                     | array of [tag](/developers/resources/channel#forum-tag-object) objects            | the set of tags that can be used in a `GUILD_FORUM` or a `GUILD_MEDIA` channel                                                                                                                                                                                                                         |
...
| default_reaction_emoji?             | ?[default reaction](/developers/resources/channel#default-reaction-object) object | the emoji to show in the add reaction button on a thread in a `GUILD_FORUM` or a `GUILD_MEDIA` channel                                                                                                                                                                                                 |
...
| default_sort_order?                 | ?integer                                                                          | the [default sort order type](/developers/resources/channel#channel-object-sort-order-types) used to order posts in `GUILD_FORUM` and `GUILD_MEDIA` channels. Defaults to `null`, which indicates a preferred sort order hasn't been set by a channel admin                                            |
| default_forum_layout?               | integer                                                                           | the [default forum layout view](/developers/resources/channel#channel-object-forum-layout-types) used to display posts in `GUILD_FORUM` channels. Defaults to `0`, which indicates a layout view has not been set by a channel admin                                                                   |
| application_id?                     | ?snowflake                                                                        | the application id; only applicable for `APPLICATION` channels                                                                                                                                                                                                                                         |

\* `rate_limit_per_user` also applies to thread creation. Users can send one message and create one thread during each `rate_limit_per_user` interval.

\*\* For threads created before July 1, 2022, the message count is inaccurate when it's greater than 50.

<ManualAnchor id="channel-object-channel-types" />
###### Channel Types
...
| GUILD_APP           | 21 | Channel powered by an application                                                                                                                          |
...
<ManualAnchor id="channel-object-video-quality-modes" />
###### Video Quality Modes
...
<ManualAnchor id="channel-object-channel-flags" />
###### Channel Flags
...
| CHANNEL_OBFUSCATED          | `1 << 17` | this channel's metadata has been obfuscated because the current user cannot view it. Only ever set on channels received over the [Gateway](/developers/events/gateway); the HTTP API never sets this flag. See [Obfuscated Channels](/developers/resources/channel#channel-object-obfuscated-channels). |
| IS_SPOILER_CHANNEL          | `1 << 21` | this channel is a Spoiler Channel i.e. users must opt in to view its contents. Can be set on all textual guild channels and voice channels (not `GUILD_STAGE`). Can only be set if channel's `nsfw` is false                                                                                            |

<ManualAnchor id="channel-object-obfuscated-channels" />
###### Obfuscated Channels

Over the [Gateway](/developers/events/gateway), a client will receive a channel object with obfuscated metadata for guild channels it does not have permission to view. Permission to view a channel is defined by having `VIEW_CHANNEL` permission on a channel or by being connected to a voice channel. Channel categories are viewable if any of their child channels are viewable.

Over the [HTTP API](/developers/resources/guild#get-guild-channels), channels that a client cannot view will be omitted from the response entirely.

<Warning>
Starting November 16, 2026, channels will be obfuscated if your bot doesn't have permissions to view them. Currently, channels are only obfuscated if the client has opted into the `CHANNEL_OBFUSCATION` [capability](/developers/events/gateway-events#identify-gateway-capabilities) or through the [**Private Channel Obfuscation** developer portal toggle](https://discord.com/developers/applications/select/bot) for testing. See [Channel Obfuscation for Users and Bots](/developers/change-log#channel-obfuscation-for-users-and-bots) for more information.
</Warning>

Obfuscated channels are dispatched through the normal [Channel Create](/developers/events/gateway-events#channel-create) and [Channel Update](/developers/events/gateway-events#channel-update) gateway events, including within the channel list of a [Guild Create](/developers/events/gateway-events#guild-create) event.

To reliably detect whether a channel object has been obfuscated, check whether its `flags` field has the `CHANNEL_OBFUSCATED` [channel flag](/developers/resources/channel#channel-object-channel-flags) (`1 << 17`) set. Do not rely on inspecting `name` or any other obfuscated field. The `permission_overwrites` for an obfuscated channel will contain only one entry denying `VIEW_CHANNEL` for the guild's `@everyone` role.

<Info>
`id`, `type`, `position`, and `parent_id` will not be obfuscated, even on an obfuscated channel. Other fields should not be relied on.
</Info>

When a bot user regains visibility into a previously obfuscated channel (for example, a permission overwrite change, a change to the bot user's roles, a change to a role's permissions, or the bot user joining a voice channel it previously couldn't see), the Gateway dispatches a [Channel Update](/developers/events/gateway-events#channel-update) event containing the full, unobfuscated channel data. If the channel's parent category was also obfuscated (because the bot user couldn't see it either), that category also receives a Channel Update event with its full, unobfuscated data.

[Interactions](/developers/interactions/receiving-and-responding) are built through a separate path that does not apply obfuscation, so an app always receives full channel data in interaction payloads for channels it can act on.

<ManualAnchor id="channel-object-sort-order-types" />
###### Sort Order Types
...
<ManualAnchor id="channel-object-forum-layout-types" />
###### Forum Layout Types
...
<ManualAnchor id="channel-object-example-guild-text-channel" />
...
<ManualAnchor id="channel-object-example-guild-announcement-channel" />
...
<ManualAnchor id="channel-object-example-guild-voice-channel" />
...
<ManualAnchor id="channel-object-example-dm-channel" />
###### Example DM Channel
...
<ManualAnchor id="channel-object-example-group-dm-channel" />
...
<ManualAnchor id="channel-object-example-channel-category" />
...
<ManualAnchor id="channel-object-example-thread-channel" />
...
<ManualAnchor id="followed-channel-object-followed-channel-structure" />
...
<ManualAnchor id="overwrite-object-overwrite-structure" />
###### Overwrite Structure
...
<ManualAnchor id="thread-metadata-object-thread-metadata-structure" />
...
<ManualAnchor id="thread-member-object-thread-member-structure" />
...
\* These fields are omitted on the member sent within each thread in the [GUILD_CREATE](/developers/events/gateway-events#guild-create) event.
...
<ManualAnchor id="default-reaction-object-default-reaction-structure" />
...
<ManualAnchor id="forum-tag-object-forum-tag-structure" />
###### Forum Tag Structure
...
## Get Channel
<Route method="GET">/channels/[\{channel.id\}](/developers/resources/channel#channel-object)</Route>
...
## Modify Channel
<Route method="PATCH">/channels/[\{channel.id\}](/developers/resources/channel#channel-object)</Route>
...
<ManualAnchor id="modify-channel-json-params-group-dm" />
...
<ManualAnchor id="modify-channel-json-params-guild-channel" />
...
| permission_overwrites\*\*          | ?array of partial [overwrite](/developers/resources/channel#overwrite-object) objects | channel or category-specific permissions                                                                                                                                                 | All                                            |
| parent_id                          | ?snowflake                                                                            | id of the new parent category for a channel                                                                                                                                              | Text, Voice, Announcement, Stage, Forum, Media |
| rtc_region                         | ?string                                                                               | channel [voice region](/developers/resources/voice#voice-region-object) id, automatic when set to null                                                                                   | Voice, Stage                                   |
| video_quality_mode                 | ?integer                                                                              | the camera [video quality mode](/developers/resources/channel#channel-object-video-quality-modes) of the voice channel                                                                   | Voice, Stage                                   |
...
| flags                              | integer                                                                               | [channel flags](/developers/resources/channel#channel-object-channel-flags) combined as a [bitfield](https://en.wikipedia.org/wiki/Bit_field).                                           | Text, Voice, Announcement, Forum, Media        |
| available_tags                     | array of [tag](/developers/resources/channel#forum-tag-object) objects                | the set of tags that can be used in a `GUILD_FORUM` or a `GUILD_MEDIA` channel; limited to 20                                                                                            | Forum, Media                                   |
| default_reaction_emoji             | ?[default reaction](/developers/resources/channel#default-reaction-object) object     | the emoji to show in the add reaction button on a thread in a `GUILD_FORUM` or a `GUILD_MEDIA` channel                                                                                   | Forum, Media                                   |
...
| default_sort_order                 | ?integer                                                                              | the [default sort order type](/developers/resources/channel#channel-object-sort-order-types) used to order posts in `GUILD_FORUM` and `GUILD_MEDIA` channels                             | Forum, Media                                   |
| default_forum_layout               | integer                                                                               | the [default forum layout type](/developers/resources/channel#channel-object-forum-layout-types) used to display posts in `GUILD_FORUM` channels                                         | Forum                                          |
...
<ManualAnchor id="modify-channel-json-params-thread" />
###### JSON Params (Thread)
...
<Route method="DELETE">/channels/[\{channel.id\}](/developers/resources/channel#channel-object)</Route>
...
<Route method="PUT">/channels/[\{channel.id\}](/developers/resources/channel#channel-object)/permissions/[\{overwrite.id\}](/developers/resources/channel#overwrite-object)</Route>
...
<ManualAnchor id="edit-channel-permissions-json-params" />
###### JSON Params
...
## Get Channel Invites
<Route method="GET">/channels/[\{channel.id\}](/developers/resources/channel#channel-object)/invites</Route>
...
<Route method="POST">/channels/[\{channel.id\}](/developers/resources/channel#channel-object)/invites</Route>
...
<ManualAnchor id="create-channel-invite-jsonform-params" />
###### JSON/Form Params
...
| target_type           | integer             | the [type of target](/developers/resources/invite#invite-object-invite-target-types) for this voice channel invite                        |                  |
...
| target_user_ids?\*\*  | array of snowflakes | an array of IDs of all users able to see and accept this invite. Max of 1000 IDs                                                          |                  |
...
<Route method="DELETE">/channels/[\{channel.id\}](/developers/resources/channel#channel-object)/permissions/[\{overwrite.id\}](/developers/resources/channel#overwrite-object)</Route>
...
<Route method="POST">/channels/[\{channel.id\}](/developers/resources/channel#channel-object)/followers</Route>
...
<ManualAnchor id="follow-announcement-channel-json-params" />
###### JSON Params
...
<Route method="POST">/channels/[\{channel.id\}](/developers/resources/channel#channel-object)/typing</Route>
...
<Route method="PUT">/channels/[\{channel.id\}](/developers/resources/channel#channel-object)/recipients/[\{user.id\}](/developers/resources/user#user-object)</Route>

Adds a recipient to a Group DM using their access token.

<ManualAnchor id="group-dm-add-recipient-json-params" />
###### JSON Params
...
<Route method="DELETE">/channels/[\{channel.id\}](/developers/resources/channel#channel-object)/recipients/[\{user.id\}](/developers/resources/user#user-object)</Route>

Removes a recipient from a Group DM.

## Start Thread from Message
<Route method="POST">/channels/[\{channel.id\}](/developers/resources/channel#channel-object)/messages/[\{message.id\}](/developers/resources/message#message-object)/threads</Route>
...
<ManualAnchor id="start-thread-from-message-json-params" />
###### JSON Params
...
<Route method="POST">/channels/[\{channel.id\}](/developers/resources/channel#channel-object)/threads</Route>
...
<ManualAnchor id="start-thread-without-message-json-params" />
###### JSON Params
...
<ManualAnchor id="start-thread-in-forum-or-media-channel-jsonform-params" />
###### JSON/Form Params
...
<ManualAnchor id="start-thread-in-forum-or-media-channel-forum-and-media-thread-message-params-object" />
...
## Join Thread
<Route method="PUT">/channels/[\{channel.id\}](/developers/resources/channel#channel-object)/thread-members/@me</Route>
...
## Add Thread Member
<Route method="PUT">/channels/[\{channel.id\}](/developers/resources/channel#channel-object)/thread-members/[\{user.id\}](/developers/resources/user#user-object)</Route>
...
## Leave Thread
<Route method="DELETE">/channels/[\{channel.id\}](/developers/resources/channel#channel-object)/thread-members/@me</Route>
...
<Route method="DELETE">/channels/[\{channel.id\}](/developers/resources/channel#channel-object)/thread-members/[\{user.id\}](/developers/resources/user#user-object)</Route>
...
## Get Thread Member
<Route method="GET">/channels/[\{channel.id\}](/developers/resources/channel#channel-object)/thread-members/[\{user.id\}](/developers/resources/user#user-object)</Route>
...
<ManualAnchor id="get-thread-member-query-string-params" />
###### Query String Params

| Field        | Type                                                   | Description                                                                                                       |
|--------------|--------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
| with_member? | [boolean](/developers/reference#boolean-query-strings) | Whether to include a [guild member](/developers/resources/guild#guild-member-object) object for the thread member |

## List Thread Members
<Route method="GET">/channels/[\{channel.id\}](/developers/resources/channel#channel-object)/thread-members</Route>
...
<ManualAnchor id="list-thread-members-query-string-params" />
###### Query String Params

| Field        | Type                                                   | Description                                                                                                        |
|--------------|--------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------|
| with_member? | [boolean](/developers/reference#boolean-query-strings) | Whether to include a [guild member](/developers/resources/guild#guild-member-object) object for each thread member |
...
<Route method="GET">/channels/[\{channel.id\}](/developers/resources/channel#channel-object)/threads/archived/public</Route>
...
<ManualAnchor id="list-public-archived-threads-query-string-params" />
###### Query String Params
...
<ManualAnchor id="list-public-archived-threads-response-body" />
###### Response Body
...
<Route method="GET">/channels/[\{channel.id\}](/developers/resources/channel#channel-object)/threads/archived/private</Route>
...
<ManualAnchor id="list-private-archived-threads-query-string-params" />
###### Query String Params
...
<ManualAnchor id="list-private-archived-threads-response-body" />
###### Response Body
...
<Route method="GET">/channels/[\{channel.id\}](/developers/resources/channel#channel-object)/users/@me/threads/archived/private</Route>
...
<ManualAnchor id="list-joined-private-archived-threads-query-string-params" />
###### Query String Params
...
<ManualAnchor id="list-joined-private-archived-threads-response-body" />
###### Response Body
